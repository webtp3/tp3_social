...
class Tp3SharesController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction()
    {
    	...
    	$this->response->addAdditionalHeaderData('<link href="'.\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath( $this->extKey ).'Resources/Public/Css/'.$this->layout.'/style.css" rel="stylesheet" type="text/css" />');
