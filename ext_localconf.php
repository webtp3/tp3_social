			...
			wizards.newContentElement.wizardItems.plugins {
				elements {
					tp3facebook {
						...
						title = LLL:EXT:tp3_social/Resources/Private/Language/locallang_db.xlf:tx_tp3_social_domain_model_tp3facebook
						description = LLL:EXT:tp3_social/Resources/Private/Language/locallang_db.xlf:tx_tp3_social_domain_model_tp3facebook.description
						tt_content_defValues {
							CType = list
